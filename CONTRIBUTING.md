...
6. **Run e2e tests**:
   ...
   **E2E Test Requirements:**
   ...
   - ✅ Multi-user agent sharing and visibility (public/private/readonly)
   - ✅ Model selection and persistence
   - ✅ Responsive design validation
   - ✅ Automatic test data cleanup

   See our [E2E Testing Guide](./docs/tips-guides/e2e-testing-guide.md) for detailed information on writing and debugging tests.
